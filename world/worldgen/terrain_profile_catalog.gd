...
func _set_defaults() -> void:
	...
	_values = PackedFloat32Array([
		...
		54.0, 5.0, 0.012, 1.5, 0.0, 0.75, 2.2, 0.25,
		61.0, 14.0, 0.014, 3.0, 0.18, 0.60, 4.0, 0.35,
		70.0, 18.0, 0.010, 2.5, 0.12, 0.35, 3.0, 0.28,
		83.0, 32.0, 0.009, 4.0, 0.55, 0.20, 6.0, 0.52,
		96.0, 42.0, 0.008, 5.0, 0.70, 0.10, 7.5, 0.65,
	])
