...
func _set_defaults() -> void:
	...
	_values = PackedFloat32Array([
		...
		54.0, 5.0, 0.012, 1.5, 0.0, 0.75, 3.0, 0.45,
		61.0, 14.0, 0.014, 3.0, 0.18, 0.60, 5.5, 0.70,
		70.0, 18.0, 0.010, 2.5, 0.12, 0.35, 4.0, 0.55,
		83.0, 32.0, 0.009, 4.0, 0.55, 0.20, 8.0, 1.10,
		96.0, 42.0, 0.008, 5.0, 0.70, 0.10, 10.0, 1.35,
	])
