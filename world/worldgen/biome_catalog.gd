...
func _init() -> void:
	_add("plains", 0.55, 0.52, BLOCK_GRASS, BLOCK_DIRT, BLOCK_SAND, 3, Color("#78ae45"), DECORATION_GRASSLAND, TYPE_OAK)
	...
	_add("snow", 0.12, 0.58, BLOCK_SNOW, BLOCK_DIRT, BLOCK_GRAVEL, 3, Color("#c5d8d2"), DECORATION_CONIFER, TYPE_SPRUCE)
	_add("swamp", 0.62, 0.88, BLOCK_MUD, BLOCK_DIRT, BLOCK_CLAY, 4, Color("#557a3c"), DECORATION_WETLAND, TYPE_REEDS)
	...
	_add("beach", 0.62, 0.45, BLOCK_SAND, BLOCK_SAND, BLOCK_SAND, 3, Color("#b9ac62"), DECORATION_NONE, TYPE_NONE)
	_add("river", 0.50, 0.70, BLOCK_SAND, BLOCK_DIRT, BLOCK_GRAVEL, 2, Color("#548c6b"), DECORATION_WETLAND, TYPE_REEDS)
	_add("jungle", 0.74, 0.80, BLOCK_GRASS, BLOCK_DIRT, BLOCK_MUD, 4, Color("#3d8d36"), DECORATION_TROPICAL, TYPE_JUNGLE_TREE)
	_add("savanna", 0.72, 0.38, BLOCK_GRASS, BLOCK_DIRT, BLOCK_SAND, 3, Color("#94a343"), DECORATION_GRASSLAND, TYPE_ACACIA)
	_add("taiga", 0.28, 0.62, BLOCK_GRASS, BLOCK_DIRT, BLOCK_GRAVEL, 4, Color("#426c4d"), DECORATION_CONIFER, TYPE_SPRUCE)
	_add("badlands", 0.82, 0.32, BLOCK_RED_SAND, BLOCK_TERRACOTTA, BLOCK_RED_SAND, 5, Color("#b76b3f"), DECORATION_BADLANDS, TYPE_CACTUS)
	_add("meadow", 0.46, 0.66, BLOCK_GRASS, BLOCK_DIRT, BLOCK_GRAVEL, 3, Color("#7fb65b"), DECORATION_GRASSLAND, TYPE_BIRCH)
