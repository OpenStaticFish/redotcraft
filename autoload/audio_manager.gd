...
func _build_block_materials() -> void:
	var groups := {
		"grass": [BlockRegistry.BLOCK_GRASS, BlockRegistry.BLOCK_LEAVES, BlockRegistry.BLOCK_SPRUCE_LEAVES,
			...
			BlockRegistry.BLOCK_ANEMONE, BlockRegistry.BLOCK_CAVE_MOSS],
		...
		"stone": [BlockRegistry.BLOCK_STONE, BlockRegistry.BLOCK_COBBLESTONE, BlockRegistry.BLOCK_BEDROCK,
			...
			BlockRegistry.BLOCK_TORCH, BlockRegistry.BLOCK_CORAL_SUBSTRATE, BlockRegistry.BLOCK_DRIPSTONE,
			BlockRegistry.BLOCK_MOSS, BlockRegistry.BLOCK_DEEPSTONE, BlockRegistry.BLOCK_SCULK,
			BlockRegistry.BLOCK_CALCITE, BlockRegistry.BLOCK_GEODE_SHELL, BlockRegistry.BLOCK_AMETHYST,
			BlockRegistry.BLOCK_CRYSTAL_BUD],
